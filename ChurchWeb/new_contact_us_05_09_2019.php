...
$to	="contactus@churchweb.kalloopparapally.com";
    ...
    <section class="contact-wthree py-sm-5 py-4" id="contact">
        <div class="container pt-lg-5">
            <div class="title-desc text-center pb-sm-3">
                <h3 class="main-title-w3pvt" style="text-decoration:none;color: rgb(97, 7, 7);">contact us</h3>
            ...
            <div class="row mt-4">
                <div class="col-lg-5 text-center">
                    <h5 class="cont-form" data-blast="color" style="color: rgb(97, 7, 7);">get in touch</h5>
                    <div class="row flex-column">
                       ...
                       <!-- <div class="contact-w3 my-4">
						...
						<img class="card-img-bottom" src="new_images/about/contact.jpg" alt="Card image cap">
                            ...
                            <address>St. Mary's Orthodox Church <br>Kallooppara P.O<br>Thiruvalla<br>Pathanamthitta District<br>Kerala<br>India<br class="fa fa-phone mb-3" data-blast="color">Ph. +91 469 2677211<br>Email : info@kalloopparachurch.com</address>
                        </div>
                    </div>
				...
				<?php
                   ...
                   ?>
                    <h5 class="cont-form" data-blast="color" style="color: rgb(97, 7, 7);">contact form</h5>
                    <div class="contact-form-wthreelayouts">
                        <form  class="register-wthree" id="contact-form" role="form" novalidate="novalidate" method="post" action="new_contact_us.php">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="phone" name="phone" value="Telephone" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Telephone';}"  required="">
                            </div>
                            <div class="form-group">
                                <label>
                                    Email
                                </label>
                                <input class="form-control" type="email" placeholder="example@email.com" id="email" name="email" placeholder="Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}"  required="">
                            </div>
                            <div class="form-group">
                                <label>
                                    Your message
                                </label>
                                <textarea placeholder="Type your message here" class="form-control" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Message...';}" class="form-control" id="message" name="message"></textarea>
                            </div>
							
							
									
                            <div class="form-group mb-0"><input type="hidden" name="IsSubmit" value="frmenquiry">
                                <button type="submit" class="btn btn-w3layouts btn-block  bg-theme text-white w-100 font-weight-bold text-uppercase" value="Submit" class="btn btn-default" id="submit" name="submit"  data-blast="bgColor">Send</button>
                            </div>
                        </form>
                    </div>
                </div>
