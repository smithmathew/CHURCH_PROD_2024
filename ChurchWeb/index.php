...
" id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
                ...
                <div class="row py-4">
                    <div class="col-md-4 col-6">
                        <div class="counter">
                            ...
                            <p class="count-text text-uppercase text-white"><a href ="new_mem.php">Families</a></p>
                        </div>
                    </div>
                    <div class="col-md-4 col-6">
                        <div class="counter">
                            ...
                            <p class="count-text text-uppercase text-white"><a href ="Launching_soon.html">Marriages</a></p>
                        </div>
                    </div>
                    <!-- <div class="col-md-4 col-6 ">
                        <div class="counter">
                    ...
                    <div class="col-md-4 col-6 ">
                        <div class="counter">
                            ...
                            <p class="count-text text-uppercase text-white"><a href ="Launching_soon.html">Demisis</a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row price-row">
                <div class="col-lg-4 col-sm-6 column mb-lg-0 mb-4">
                    <div class="box" style="border: 5px solid rgb(104, 0, 52);">
                        ...
                        <div class="price">
                            <h6>DATE - <sup></sup><span class="font-weight-bold">01-08-2020</span></h6>
                        </div>
                        <div class="option">
                            <ul>
                                <li>TIME : 6:45 AM</li>
                ...
                <div class="col-lg-4 col-sm-6 column mb-lg-0 mb-4">
                    <div class="box"style="border: 5px solid rgb(104, 0, 52);">
                        ...
                        <div class="price">
                            <h6>DATE- <sup></sup><span class="font-weight-bold">08-10-1019</span></h6>
                        </div>
                        <div class="option">
                            <ul>
                                <li>Time:7:30 </li>
                    ...
                    <div class="box" style="border: 5px solid rgb(104, 0, 52);">
                        ...
                        <div class="option">
                            <ul>
                                ...
                                <li>SPEECH: FR KOSHI PHILIP/FR LIJO</li>
                                <!-- <li>20 Email Address</li> -->
                                <li>View Live</li>
                            </ul>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="#exampleModal3" data-toggle="modal" aria-pressed="false" data-target="#exampleModal3"
                                role="button">
                                <img class="card-img-bottom" src="new_images/home_bishop&Vicar/fr_koshy_philip.jpg" alt="Card image cap">
                                <span class="fa fa-user post-icon bg-theme" aria-hidden="true" style="background-color: rgb(104, 0, 52);"></span>
                            </a>
                        </div>
                        <div class="card-body">
                            <h5 class="blog-title card-title font-weight-bold">
                                <a href="#exampleModal3" data-toggle="modal" aria-pressed="false" data-target="#exampleModal3"
                                    role="button">Rev. Fr. Koshy Philip</a>
                                    <br>
                            </h5>
                            <!-- <p>At vero eos et accusam et justo duo dolores et ea rebum. Lorem ipsum dolor sit
                                ametLorem ipsum dolor sit amet,sed diam nonumy.</p> -->
                    ...
                    <div class="card">
                        <div class="card-header p-0  position-relative">
                            <a href="#exampleModal4" data-toggle="modal" aria-pressed="false" data-target="#exampleModal4"
                                role="button">
                                <img class="card-img-bottom" src="new_images/home_bishop&Vicar/fr_lijo_mathew.jpg" alt="Card image cap">
                                <span class="fa fa-user post-icon bg-theme" aria-hidden="true" style="background-color: rgb(104, 0, 52);"></span>
                            </a>
                        </div>
                        <div class="card-body">
                            <h5 class="blog-title card-title font-weight-bold">
                                <a href="#exampleModal4" data-toggle="modal" aria-pressed="false" data-target="#exampleModal4"
                                    role="button">Rev. Fr. Lijo Mathew</a>
                                    <br>
                            </h5>
                            <!-- <p>At vero eos et accusam et justo duo dolores et ea rebum. Lorem ipsum dolor sit
                                ametLorem ipsum dolor sit amet,sed diam nonumy.</p> -->
    ...
    <div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <img src="new_images/home_bishop&Vicar/fr_koshy_philip.jpg" class="img-fluid" alt="" />
                    <p class="text-left my-4">
                            Date of birth : <br>

                            Family Details : Kalathil. <br>
                            
                            Home Parish : St George orthodox church,Muthoor<br>
                            ...
                            Contact Details : Mob - +91 9447102564. <br>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="exampleModal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header bg-theme">
                    <h5 class="modal-title" id="exampleModalLabel4">Fr LIJO MATHEW</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body text-center">
                    <img src="new_images/home_bishop&Vicar/fr_lijo_mathew.jpg" class="img-fluid" alt="" />
                    <p class="text-left my-4">
                            Date of birth : 1984-sep-24<br>

                            Family Details : Chamathil. <br>
                            
                            Home Parish : St George Orthodox Church,Chengaroor<br>
                         ...
                         Seminary : <br>
                            ...
                            Contact Details : Mob - +91 9846086042 <br>
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="modal fade" id="xmasmodal2" role="dialog">
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content modal-full" style="border: 0px solid #f8f9fa;background-color: rgba(0, 0, 0, 0.075);">
                            ...
                            padding: 15px 15px 0 15px;
                            background-image: url(new_images/home_modal/noyamb.jpg);
                            height: 363px;
                            background-size: cover;
                            background-repeat: no-repeat;">
                              </div>
