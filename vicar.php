	...
	<tr>
		...
		<td class="td_box_top" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="5">				
				...
				<tr>								
					<td class="td_blue_heading">OUR VICAR - Rev. Fr. Koshy Philip</td>					
				</tr>
			</table>
		</td>
		<td valign="top" class="td_space_top">&nbsp;</td>
				...
				<tr>								
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="left" valign="top"><br><img border="0" src="images/vicars/fr_koshy_philip.jpg" hspace="8" width="270"></td>
								<td><br><b>Date of birth</b> :  
								<br><br><b>Family Details</b> : Kalathil. 
								<br><br><b>Home Parish</b> : 
								<br><br><b>Qualification</b> :  
								<br><br><b>Seminary</b> : 
								<br><br><b>Date of Ordination</b> : 
								<br><br><b>Personal Details</b> : 
								<br><br><b>Contact Details</b> : Mob - +91 9447102564. <br><br></td>				
							</tr>
						</table><br><br>
					</td>
				</tr>															
