...
$username = "kalloopp_church";
$password = "kalloopp890";
$dbname = "kalloopp_churchDb";
...
$query = "INSERT INTO new_church_feedback(feed_name,feed_email,	feed_phone,feed_message,feed_status)  
           VALUES('$name', '$email','$txtphone','$txtcomments','$Status');";
...
if ($conn->query($query) === TRUE) {
   // echo "New record created successfully";
    ...
    echo "if";
                             ...
                             $_SESSION['success']="Dear ".ucfirst($name).",<br><br>Thank You for feedback us your enquiry. We appreciate and acknowledge your interest shown towards us.<br>
    ...
    $_SESSION['success']="Dear ".ucfirst($name).",<br><br>Technical Error.Our Team is working on this";
...
//$to	="mailus@kalloopparapally.com";
...
"new_images/title/title.png" 
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.mis">
