...
.bannerr {
    background: url(new_images/15Noyamb/kodiyettu.jpeg) center no-repeat;
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
            ...
            <nav class="navbar navbar-expand-lg navbar-light fixed-top navbar-expand-lg navbar-light navbar-fixed-top">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-lg-auto text-center">
                        ...
                        <li class="nav-item  mt-lg-0 mt-3">
                            <a class="nav-link" href="new_corona_news.php">Corona Updates</a>
                        </li>
                        <li class="nav-item mt-lg-0 mt-3">
                    ...
                    <div class="container">
                        <div class="banner-text" style="padding-top: 18vw;">
                            <div class="slider-info">
                                ...
                                <p>"No man ever prayed heartily without learning something.."</p>
 ...
 <br>
    ...
    <div class="row" style=" margin-left: 20px;margin-right: 10px;">
        <div class="container pt-lg-5" style="padding-top:0rem !important;">
     <h3 class="main-title-w3pvt text-center" style="text-decoration:none;color: rgb(104, 0, 52);">15 Noyamb</h3></div><br>
               <br>
                <div class="s col-xxs-12 col-xs-6 col-sm-6 col-md-4">
                    <div class="blog-post text-center wow fadeInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                        <div class="thumb">
                            <img class="res" src="new_images/15Noyamb/kodiyettu.jpeg" alt="">
                        </div>
                        <div class="details">
                            
                        
                            <h3 class="post-title tdu-hvr"  style="font-size: 20px;">15 Noyamb - Kodiyettu</h3>
                            <p>St. Mary's Orthodox Church is situated at the heart of a small village called Kallooppara, Pathanamthitta District, Kerala, India. It is one of the oldest and renowned churches in Kerala and a priced possession of Malankara Sabha.</p>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="s col-xxs-12 col-xs-6 col-sm-6 col-md-4">
                    <div class="blog-post text-center wow fadeInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                        <div class="thumb">
                            <img class="res" src="new_images/events/parumala.jpg" alt="">
                        </div>
                        <div class="details">
                            
                        
                            <h3 class="post-title tdu-hvr"  style="font-size: 20px;">VIDEO</h3>
                            <!-- <p>First Saturday of every November there will be evening prayer , followed by procession and dipashika.Youth used to conduct song service in name of " punyasmrithy" along with that meditation will be there. All the shrines in different part of the church used to have meditation message delivery , afterwards Sunday mornings holy mass will be there.</p> -->
                        </div>
                    </div>
                </div>
               ...
               <div class="s col-xxs-12 col-xs-6 col-sm-6 col-md-4">
                    <div class="blog-post text-center wow fadeInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                        <div class="thumb">
                            <img class="res" src="new_images/15Noyamb/committe.jpeg" alt="">
                        </div>
                        <div class="details">
                            
                        
                            <h3 class="post-title tdu-hvr"  style="font-size: 20px;">കമ്മിറ്റി</h3>
                            <p>കല്ലൂപ്പാറ സെന്റ് മേരീസ് ഓർത്തഡോക്സ് വലിയ പള്ളിയിലെ പതിനഞ്ചുനോമ്പ് വിശേഷാൽ 101സബ് കമ്മിറ്റി അംഗങ്ങൾ</p>
                        </div>
                    </div>
                </div>
              ...
              <!-- <div class="s col-xxs-12 col-xs-6 col-sm-6 col-md-4">
                    <div class="blog-post text-center wow fadeInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                        <div class="thumb">
                            <img class="res" src="new_images/events/abayam.jpg" alt="">
                        </div>
                        <div class="details">
                            
                        
                            <h3 class="post-title tdu-hvr"  style="font-size: 20px;">Abhayam Prayer</h3>
                            <p>St. Mary's Orthodox Church is situated at the heart of a small village called Kallooppara, Pathanamthitta District, Kerala, India. It is one of the oldest and renowned churches in Kerala and a priced possession of Malankara Sabha.</p>
                        </div>
                    </div>
                </div>
                 <div class="s col-xxs-12 col-xs-6 col-sm-6 col-md-4">
                    <div class="blog-post text-center wow fadeInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                        <div class="thumb">
                            <img class="res" src="new_images/events/marianpuraskaram.jpg" alt="">
                        </div>
                        <div class="details">
                            
                        
                            <h3 class="post-title tdu-hvr"  style="font-size: 20px;">Marian Puraskaram</h3>
                            <p>St. Mary's Orthodox Church is situated at the heart of a small village called Kallooppara, Pathanamthitta District, Kerala, India. It is one of the oldest and renowned churches in Kerala and a priced possession of Malankara Sabha.</p>
                        </div>
                    </div>
                </div> -->
